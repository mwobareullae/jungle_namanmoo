...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("concentration_text", sa.String(length=160), nullable=True),
        sa.Column("concentration_value", sa.Numeric(14, 6), nullable=True),
        sa.Column("concentration_unit", sa.String(length=16), nullable=True),
